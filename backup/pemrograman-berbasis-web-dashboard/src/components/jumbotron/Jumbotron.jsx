      ...
      >
        ...
        >
          ...
          <div className="__main-content w-full md:w-7/12  flex flex-col justify-center items-center md:items-start">
            ...
            >
              <MdOutlineWavingHand className={"inline"} /> Selamat datang di
            </h1>
            <h1
              style={{ fontWeight: 700 }}
              className={
            ...
            >
              ...
              <p className={"py-3 text-lg lg:text-2xl"}>
                <span ref={el}></span>
              </p>
            </h1>
            <div className="__main-submenu py-5 w-full flex flex-col lg:flex-row lg:items-start gap-3 justify-center items-center">
              <div class="w-full p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-slate-800 dark:border-gray-700">
                {" "}
                <HiOutlineUserGroup
                  className={"text-4xl my-3 text-violet-500"}
                />
                <a href="#">
                  <h5 class="mb-2 text-lg font-semibold tracking-tight text-violet-500 dark:text-white">
                    Anggota
                  </h5>
                </a>
                <p
              ...
              <div class="w-full p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-slate-800 dark:border-gray-700">
                {" "}
                <BiTask className={"text-4xl my-3 text-violet-500"} />
                <a href="#">
                  <h5 class="mb-2 text-lg font-semibold tracking-tight text-violet-500 dark:text-white">
                    Tugas
                  </h5>
              ...
              <div class="w-full p-6 bg-white border border-gray-200 rounded-2xl shadow dark:bg-slate-800 dark:border-gray-700">
                {" "}
                <TbMessage2 className={"text-4xl my-3 text-violet-500"} />
                <a href="#">
                  <h5 class="mb-2 text-lg font-semibold tracking-tight text-violet-500 dark:text-white">
                    Saran & Feedback
                  </h5>
