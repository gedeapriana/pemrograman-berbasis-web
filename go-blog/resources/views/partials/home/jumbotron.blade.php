<div id="jumbotron-root" class="w-full h-[400px] lg:h-auto flex justify-between items-center">
  <div id="jumbotron-welcome" class="">
    ...
    <a href="" class="text-[1.1rem] md:text-[1.2rem lg:text-[1.4rem]] relative inline-block py-3 px-5 font-[raleway] my-5 bg-white border-[1px] border-slate-900">Mulai Baca</a>
  </div>
  <div id="jumbotron-images" class="hidden lg:block">
    <img width="600" src="assets/images/home/jumbotron.png" class="mb-10" alt="">
  </div>
</div>
