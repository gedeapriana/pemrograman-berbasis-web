...
const Member = () => {
  return (
    <>
      ...
      {/* </div> */}
      <section id={"__member-root"} className="bg-violet-400 dark:bg-slate-800 py-24 w-full flex items-center justify-center">
        <section id="__member-wrapper" className={"h-full text-slate-50 w-11/12 flex flex-col items-center justify-center lg:w-9/12 xl:w-8/12"}>
          <p id="__member-header" className={"text-xl lg:text-3xl pb-8 flex items-center justify-center gap-2"}><HiOutlineUserGroup className={"inline"}/>Anggota Kelompok</p>
          <div id="__member-cards" className={"flex gap-5 lg:py-5 flex-wrap items-center justify-center"}>
